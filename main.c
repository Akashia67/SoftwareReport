...
char laugh[][30]={"はははは！","ふふふ...","あははー","はは"};
char b[][30]={"またね!！","さよなら...","さよーなら","じゃ"};
char za[][100]={"好きなものは一番初めに食べます。","ひとりでいると、落ち着きます。","日曜日は寝て過ごしたいです。","だらだらするのが嫌いです。","貯金はしなくてもなんとかなると思います。","ちまちましたことをするのが好きです","のんびり暮らしたいです。","理不尽なことは許せません。","友達を100人作るのが夢です。","たまには外に出ないといけませんね。","実は、小さなことですぐ落ち込みます。","ほめることが苦手です。"};
FILE *fp;
if ((fp=fopen("list.txt", "r"))==NULL)
printf("ファイルをオープンできません。\n");
else {
