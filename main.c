...
if(a[i]==2)
a[i]=-1;}
p[0]=2*a[0]-5*a[1]-5*a[2]-4*a[3]-4*a[4];
p[1]=2*a[0]+5*a[1]+5*a[2]+4*a[3]+4*a[4];
p[2]=3*a[0]+3*a[1]+2*a[2]-2*a[3]-10*a[4];
...
if(r==3){
char hello[][30]={"こんにちは!","こんにちは...","こんにちはー","こんにちは"};
char eat[][40]={"いただきます。","大好物だったようです。","おいしかったようです。","苦手だったようです..."};
char react[][40]={"ありがとうございます。","すごく気に入ったようです。","気に入ったようです。","気に入らなかったようです"};
char laugh[][30]={"ははははは！","ふふふ...","あははー","はは"};
char b[][30]={"またね！","さよなら...","さよーなら","じゃ"};
char za[][100]={"好きなものは一番初めに食べます。","ひとりでいると、落ち着きます。","日曜日は寝てすごしたいです。","だらだらするのが嫌いです。","貯金はしなくてもなんとかなると思います。","ちまちましたことをするのが好きです","のんびり暮らしたいです。","理不尽なことは許せません。","友達を100人作るのが夢です。","たまには外に出ないといけませんね。","実は、小さなことですぐ落ち込みます。","ほめることが苦手です。"};
FILE *fp;
if ((fp=fopen("list.txt", "r"))==NULL)
printf("ファイルをオープンできません。\n");
else {
